...
function repaintScheduleBody(curDateLoc) {
    ...
    for (var i = 0; i < scheduleItems.length; i++) {
        bodyContent += "<tr><td>" + scheduleItems[i].startTime.substring(11, 16) + "</td>" +
            ...
            "<td><div><b style='color: #464547'>" + scheduleItems[i].fare.toFixed(2) + "</b></div</td>" +
            "<td><a class='btn btn-primary' href='/admin/sale/detail/buy?id="+movieId+"&scheduleId="+scheduleItems[i].id+"' role='button' style='color: #f2eada; border-color: #464547'>选座购票</a></td></tr>";
    }
